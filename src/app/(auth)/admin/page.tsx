          ...
          {autoResult && (
            <div style={{ marginTop: "16px", padding: "16px", background: "#f3e8ff", borderRadius: "8px", border: "1px solid #d8b4fe", fontSize: isMobile ? "13px" : "14px" }}>
              ...
              <div style={{
                ...
                <p>Direction: <strong style={{ color: autoResult.direction === "long" ? "#16a34a" : "#dc2626" }}>{autoResult.direction?.toUpperCase()}</strong></p>
                <p>Current Price: <strong>{autoResult.currentPrice ?? "N/A"}</strong></p>
                <p>Entry: <strong style={{ color: "#1c69e3" }}>{autoResult.entryPrice ?? autoResult.entry ?? "N/A"}</strong></p>
                <p>SL: <strong style={{ color: "#dc2626" }}>{autoResult.stopLossPrice ?? autoResult.stopLoss ?? "N/A"}</strong></p>
                <p>TP1: <strong style={{ color: "#16a34a" }}>{autoResult.takeProfit1Price ?? autoResult.takeProfit1 ?? "N/A"}</strong></p>
                <p>TP2: <strong style={{ color: "#16a34a" }}>{autoResult.takeProfit2Price ?? autoResult.takeProfit2 ?? "N/A"}</strong></p>
                <p>TP3: <strong style={{ color: "#16a34a" }}>{autoResult.takeProfit3Price ?? autoResult.takeProfit3 ?? "N/A"}</strong></p>
                <p>Risk: <strong>{autoResult.riskPips ?? "N/A"} pips</strong></p>
                <p>Score: <strong>{autoResult.signalScore ?? autoResult.confidenceScore ?? "N/A"}/100</strong></p>
